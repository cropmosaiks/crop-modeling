...
if __name__ == "__main__":
    ...
    results_fn = f'2_sensor_top-ot-mod_{n_splits}-splits_{today}_rcf_climate-{inc_clim}_anom-{anom}.csv'
    ...
    oos_fn = f'2_sensor_top-ot-mod_oos_predictions_{n_splits}-splits_{today}_rcf_climate-{inc_clim}_anom-{anom}.csv'
