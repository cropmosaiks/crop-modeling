...
ggplot(data = one_sensor_results) +
  ...
  labs(x = expand_field('kfold_val_R2')) +
...
ggplot(data = one_sensor_results) +
  aes(x = logo_val_R2) +
  geom_histogram(bins = 30, fill = 'dodgerblue', color = 'black') +
  labs(x = expand_field('logo_val_R2')) +
  scale_x_continuous(limits = limits, expand = expansion(mult = c(.01, .01)))
```
...
ggplot(data = one_sensor_results) +
  ...
  geom_histogram(bins = 30, fill = 'dodgerblue', color = 'black') +
  labs(x = expand_field('kfold_demean_R2'))
```
...
```{r }
ggplot(data = yield, aes(x = log_yield)) +
  geom_histogram(bins = 30, fill = 'dodgerblue', color = 'black') 
```
...
```{r }
ggplot(data = yield, aes(x = prediction)) +
  geom_histogram(bins = 30, fill = 'dodgerblue', color = 'black') 
```
...
```{r }
ggplot(data = yield, aes(x = residuals)) +
  geom_histogram(bins = 30, fill = 'dodgerblue', color = 'black') 
```
